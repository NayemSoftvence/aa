// pop_call.dart (or a separate pop_call_sheet.dart if you prefer)
import 'dart:async';

import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:flutter_callkit_incoming/flutter_callkit_incoming.dart';
import 'package:livekit_calling_app/features/home/data/livekit_netlify_api.dart';
...
Future<void> openPopCall(BuildContext context, String callId) {
  ...
  return showModalBottomSheet(
    ...
    enableDrag: false, // prevent accidental drag-to-close
    isDismissible: false, // close only via buttons
    builder: (_) {
      return ChangeNotifierProvider.value(
        value: callProvider,
        child: PopCall(callId: callId),
      );
    },
  );
}
